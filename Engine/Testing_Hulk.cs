 ...
 //p1, p2, p3= { point(2, 3), point(4,5), point(10, 9) }; l1= line( p1, p3); l2= line( p2, point(6,5)); i1,_= intersection( l1, l2); i1;
//p1, p2, p3= { point(2, 3), point(4,5), point(10, 9) }; l1= segment( p1, p3); m= measure( p2, point(100000,50000)); c1= circle( p1, m); i1,i2,_= intersection( l1, c1); i1; i2;
// p1= point(3, 4); p2= point(10, 9); p3= point(11,34); p4= point(20,5); s1= segment( p1, p2); s2=line( p3, p4); i1,_= intersection( s1, s2); i1;
//p1= point(-2, 0); p2= point(2, 0); m= measure( point(0,0), point(0,3)); c1= circle( p1, m); c2= circle(p2, m); i1, i2, _= intersection( c1, c2); i1; i2;    
